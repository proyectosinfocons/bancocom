...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/usuarios/").permitAll() // Permitir crear usuarios sin autenticación
                .antMatchers(HttpMethod.GET, "/api/usuarios/").permitAll() // Permitir listar usuarios sin autenticación
